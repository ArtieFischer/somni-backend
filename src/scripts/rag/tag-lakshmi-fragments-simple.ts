#!/usr/bin/env node
/**
 * Tag Lakshmi fragments with themes - simplified version
 */
...
async function tagLakshmiFragments() {
  ...
  try {
    // Get total count of Lakshmi fragments
    ...
    console.log(`   Total Lakshmi fragments: ${totalCount}`);
...
async function main() {
  console.log('🎯 Tag Lakshmi Fragments with Themes (Simple Version)\n');
  ...
  console.log(`   Total Lakshmi fragments: ${fragmentCount}`);
}
