...
/**
 * Simplified state manager that ACTUALLY prevents repetition
 */
export class SimpleFreudianStateManager {
  private static instance: SimpleFreudianStateManager;
  ...
  private constructor() {
    logger.info('SimpleFreudianStateManager initialized');
  }
  ...
  getForbiddenOpenings(): string[] {
    return [
      ...
      'Do NOT start with "Your dream reveals"',
      'Do NOT start with "This dream reveals"',
      'Do NOT start with "In this dream"',
      'Do NOT start with "The dream shows"',
      'Do NOT start with "What we have here"'
    ];
  }
  ...
  reset(): void {
    ...
    this.recentOpenings = [];
    logger.info('SimpleFreudianStateManager reset');
  }
}